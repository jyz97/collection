...
public class RandomUtils {
    ...
    /**
     * Returns a random Direction uniformly
     * @return a random Driection uniformly
     */
    public static Direction randomDirection(Random random) {
        int i = random.nextInt(4);
        switch (i) {
            case 0:
                return Direction.RIGHTTOWARDS;
            case 1:
                return Direction.LEFTTOWARDS;
            case 2:
                return Direction.UPTOWARDS;
            case 3:
                return Direction.DOWNTOWARDS;
            default:
                return Direction.RIGHTTOWARDS;
        }
    }
