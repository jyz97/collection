...
public class TestJoinOperator {
    ...
    public void testEmptyBNLJ() {
        ...
        List<Record> emptyRecordList = new ArrayList<Record>();
        TestSourceOperator emptyOperator = new TestSourceOperator(emptyRecordList, schema);

        List<Record> recordList = new ArrayList<Record>();
        for (int v = 0; v < 100; v += 2) {
            List<DataBox> recordValues = new ArrayList<>();
            recordValues.add(new IntDataBox(v));
            recordList.add(new Record(recordValues));
        }
        TestSourceOperator nonEmptyOperator = new TestSourceOperator(recordList, schema);
...
//            System.out.println(outputIterator.next());
    ...
    @Test
    public void testDoubleEmptyBNLJ() {
        List<String> columnNames = new ArrayList<String>();
        columnNames.add("int");
        List<Type> columnTypes = new ArrayList<Type>();
        columnTypes.add(Type.intType());
        ...
        List<Record> anotherEmptyRecordList = new ArrayList<Record>();
        TestSourceOperator nonEmptyOperator = new TestSourceOperator(anotherEmptyRecordList, schema);
    ...
    @Test
    public void testDoubleEmptySMJ() {
        List<String> columnNames = new ArrayList<String>();
        columnNames.add("int");
        List<Type> columnTypes = new ArrayList<Type>();
        columnTypes.add(Type.intType());
