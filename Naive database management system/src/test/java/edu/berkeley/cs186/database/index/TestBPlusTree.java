...
//    @Test
//    @Category(PublicTests.class)
//    public void testDeletingEverything() {
//        BPlusTree tree = getBPlusTree(Type.intType(), 2);
//        float fillFactor = 0.75f;
//        assertEquals("()", tree.toSexp());
//
...
//        tree.bulkLoad(data.iterator(), fillFactor);
//
//        Iterator<RecordId> rridIter = tree.scanAll();
//        for (int i = 1; i <= 11; ++i) {
//            if (rridIter.hasNext()) {
//                rridIter.next();
//            }
...
//
//        Iterator<RecordId> ridIter = tree.scanAll();
//        System.out.println(ridIter);
//        System.out.println(ridIter.hasNext());
//        System.out.println(ridIter.hasNext());
//
//    }
...
//    @Test
//    @Category(PublicTests.class)
//    public void testPutsAndScanGreaterEqual() {
//        List<DataBox> keys = new ArrayList<>();
//        List<RecordId> rids = new ArrayList<>();
//
//        keys.add(new IntDataBox(0));
//        rids.add(new RecordId(0, (short) 0));
//        keys.add(new IntDataBox(5));
//        rids.add(new RecordId(5, (short) 5));
...
//        keys.add(new IntDataBox(13));
//        rids.add(new RecordId(13, (short) 13));
...
//        keys.add(new IntDataBox(21));
//        rids.add(new RecordId(21, (short) 21));
//        keys.add(new IntDataBox(42));
//        rids.add(new RecordId(42, (short) 42));
//        keys.add(new IntDataBox(31));
//        rids.add(new RecordId(31, (short) 31));
//
//        BPlusTree tree = getBPlusTree(Type.intType(), 2);
//        for (int i = 0; i < keys.size(); i++) {
//            tree.put(keys.get(i), rids.get(i));
...
//        System.out.println(indexIteratorToList(() -> tree.scanGreaterEqual(new IntDataBox(8))));
//        System.out.println(indexIteratorToList(() -> tree.scanGreaterEqual(new IntDataBox(12))));
//
//
//
//    }
